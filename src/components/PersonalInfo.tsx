    ...
    <section className="py-20 bg-gradient-to-br from-secondary/30 to-accent/20">
      <div className="container mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-6xl mx-auto">
          ...
          {/* Location */}
          <div className="glass-effect rounded-xl p-6 text-center hover-lift animate-bounce-in" style={{ animationDelay: '0.1s' }}>
          ...
          {/* Email */}
          <div className="glass-effect rounded-xl p-6 text-center hover-lift animate-bounce-in" style={{ animationDelay: '0.2s' }}>
            ...
            <p className="text-sm font-medium text-gradient break-all">
              zishuahmad96@outlook.com
            </p>
          </div>

          {/* Phone */}
          <div className="glass-effect rounded-xl p-6 text-center hover-lift animate-bounce-in" style={{ animationDelay: '0.3s' }}>
        ...
        <div className="absolute inset-0 pointer-events-none overflow-hidden">
          ...
          <div className="absolute bottom-20 right-10 w-16 h-16 bg-chart-2/10 rounded-full animate-float" style={{ animationDelay: '2s' }}></div>
          <div className="absolute top-1/2 left-1/4 w-12 h-12 bg-chart-3/10 rounded-full animate-float" style={{ animationDelay: '4s' }}></div>
        </div>
      </div>
    </section>
  );
